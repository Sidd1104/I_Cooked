        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">Siddhant Mohan Jha</span>, a BCA student (3rd Year, 5th Semester) at GL Bajaj Institute of Management.
              </p>
              <p className="text-sm md:text-base text-white/60 font-light leading-relaxed">
                I'm currently building full-stack, AI-integrated products — including a RAG-based due-diligence platform, a real-time group-expense app, and a personal document-intelligence system. Alongside my coursework, I've completed 4 internships in full-stack and AI engineering roles. I'm looking for full-stack developer opportunities where I can take systems from architecture to production deployment.
              </p>
            </div>
          ...
          >
            ...
            <div className="space-y-4 relative z-10">
              ...
              <ul className="space-y-3 text-xs md:text-sm text-white/80 font-light">
                ...
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold shrink-0">&#8250;</span>
                  <span className="text-white font-medium">BCA Academic Topper — Batch 24-27</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold shrink-0">&#8250;</span>
                  <span className="text-white font-medium">8.54 CGPA</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold shrink-0">&#8250;</span>
                  <span className="text-white font-medium">300+ GitHub Contributions</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold shrink-0">&#8250;</span>
                  <span className="text-white font-medium">Cisco CCNA Certified</span>
                </li>
              </ul>
            </div>
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 relative z-10">
              {['React', 'Next.js', 'Node.js', 'Express', 'PostgreSQL', 'MongoDB', 'Socket.IO'].map((tech, idx) => (
                <span
                  key={idx}
