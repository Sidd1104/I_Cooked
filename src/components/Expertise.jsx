...
const expertiseData = [
  {
    ...
    text: "Building end-to-end web applications with React/Next.js frontends and Node.js/Express backends, from UI to API to deployment.",
  ...
  },
  {
    ...
    text: "Designing retrieval-augmented generation pipelines with vector-based semantic search, grounding AI responses in real documents with source-level citations — as in DiligenceOS and DocuMind.",
    tag: "RAG · VECTOR DATABASES · LLM INTEGRATION",
    gradient: "from-[#1a0809] via-[#111111] to-[#090909]"
  },
  {
    number: "03",
    title: "Real-Time Systems",
    text: "Implementing live, multi-user synchronization using Socket.IO with JWT-authenticated, room-scoped connections — powering Kharcha's real-time expense sync.",
    tag: "SOCKET.IO · WEBSOCKETS",
    gradient: "from-[#220a0d] via-[#131313] to-[#0a0a0a]"
  },
  {
    number: "04",
    title: "Database & Backend Architecture",
    text: "Architecting relational and document data models across PostgreSQL, MongoDB, and Neon, with a focus on per-user data isolation and query performance.",
    tag: "POSTGRESQL · MONGODB · NEON",
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
          ...
          <p className="text-white/60 text-xs md:text-sm font-light leading-relaxed max-w-xs">
            Merging AI integration, real-time systems, and full-stack architecture into production-ready platforms.
          </p>
        </div>
