...
const skillCategories = [
  { 
    title: 'Languages', 
    desc: 'Core programming languages used across full-stack and systems projects.', 
    tag: 'CORE',
    skills: ['JavaScript', 'TypeScript', 'Python', 'C++', 'C#', 'SQL'] 
  },
  { 
    title: 'Frontend', 
    desc: 'Building responsive, animated, production-grade user interfaces.', 
    tag: 'CLIENT',
    skills: ['React', 'Next.js', 'Tailwind CSS', 'Framer Motion', 'HTML5', 'CSS3'] 
  },
  { 
    title: 'Backend', 
    desc: 'Designing APIs and server-side logic for real-time and AI-driven applications.', 
    tag: 'SERVER',
    skills: ['Node.js', 'Express', '.NET Web API', 'Socket.IO', 'JWT Auth', 'REST APIs'] 
  },
  { 
    title: 'Database', 
    desc: 'Structuring and securing relational and document data at scale.', 
    tag: 'DATA',
    skills: ['PostgreSQL', 'MongoDB', 'Neon', 'SQL Server', 'better-sqlite3', 'Data Isolation'] 
  },
  { 
    title: 'Tools & DevOps', 
    desc: 'Shipping and maintaining projects from local dev to production.', 
    tag: 'DEVOPS',
    skills: ['Git & GitHub', 'Docker', 'Vercel', 'Render', 'VS Code', 'Antigravity IDE'] 
  },
  { 
    title: 'AI & Emerging Tech', 
    desc: 'Applying AI/ML and retrieval-augmented systems to real products.', 
    tag: 'AI/ML',
    skills: ['RAG Pipelines', 'Prompt Engineering', 'LLM Integration', 'AI Research'] 
  },
];
